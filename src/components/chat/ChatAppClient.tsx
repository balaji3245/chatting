...
export const ChatAppClient: React.FC<ChatAppClientProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Floating Emergency Panic Exit Button (Right side, prominent) */}
      <button
        onClick={handleEmergencyExit}
        title="Panic Exit (Instant Leave & Logout)"
        className="fixed bottom-[76px] right-4 z-40 px-4 py-2.5 rounded-full bg-rose-600 hover:bg-rose-700 text-white font-bold text-sm shadow-xl border border-rose-500/40 flex items-center gap-2 transition-all active:scale-95 animate-in fade-in"
      >
